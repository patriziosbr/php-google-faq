<?php 
    ...
    $policy = [
        ...
        [
            "title" => "<h1>Perché il mio account è associato a un paese?</h1>",
            "contents" => [ 
        ...
        [
            "title" => "<h1>Stabilire il paese associato al tuo account</h1>",
            "contents" => [
        ...
        [
            "title" => "<h1>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?</h1>",
            "contents" => [
